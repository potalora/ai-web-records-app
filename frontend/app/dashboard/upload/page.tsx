                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                          ...
                          <div className="rounded-md border p-3 flex items-center gap-3 cursor-pointer hover:bg-slate-50">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">Connect to Allscripts</p>
                            </div>
                          </div>
                          <div className="rounded-md border p-3 flex items-center gap-3 cursor-pointer hover:bg-slate-50">
                            ...
                            <div>
                              <p className="font-medium">Other EHR</p>
                              <p className="text-xs text-muted-foreground">Connect to another system</p>
                            </div>
                          </div>
                        </div>
                      </div>
